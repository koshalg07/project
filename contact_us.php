...
$stat = 2;
$conn=mysqli_connect("localhost","root","","blood_donation",8111) or die("Connection error");
$sql= "insert into contact_query (query_name,query_mail,query_number,query_message,query_status) values('{$name}','{$email}','{$number}','{$message}','{$stat}')";
