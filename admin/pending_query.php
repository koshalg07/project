...
<div id="sidebar">
<?php $active="pending_query"; include 'sidebar.php'; ?>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
        ...
        $offset = ($page - 1) * $limit;
        $count=$offset+1;
        $sql1 = "select query_status from contact_query LIMIT {$offset},{$limit}";
...
<div class="table-responsive"style="text-align:center;align:center">
    <?php
    $sql1 = "SELECT * FROM contact_query where query_status=2 ";
