...
<div class="sidebar" ><b>
  ...
  <a href="query.php"   <?php if($active=='query') echo "class='act'"; ?>><span class="glyphicon glyphicon-check"></span>&nbsp&nbspCheck Query</a>
  <a href="pending_query.php"   <?php if($active=='pending_query') echo "class='act'"; ?>><span class="glyphicon glyphicon-check"></span>&nbsp&nbspCheck Pending Query</a>
